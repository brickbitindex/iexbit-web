...
class Chart extends Component {
  ...
  getPanelTitleContent() {
    ...
    const tools = [
      ...
      <a className="cmclogo" target="_blank" rel="noopener noreferrer" href={`https://coinmarketcap.com/currencies/${window.gon.current_market.base_unit.key}/`}><img src="https://assets.zjzsxhy.com/upload/047cd154-d0c6-4cfc-92ab-09bffaf83e27.svg" alt="" /> </a>,
    ];
    return tools;
  }
  @autobind
